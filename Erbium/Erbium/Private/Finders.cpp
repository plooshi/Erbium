...
uint64_t FindFinishedTargetSpline()
{
    ...
    if (!bInitialized)
    {
        ...
        else if (VersionInfo.EngineVersion == 5.1)
        {
            ...
            if (!FinishedTargetSpline)
                FinishedTargetSpline =
                    Memcury::Scanner::FindPattern("48 8B C4 48 89 58 ? 48 89 70 ? 48 89 78 ? 55 41 55 41 56 48 8D A8 ? ? ? ? 48 81 EC ? ? ? ? 48 8B 05 ? ? ? ? 48 33 C4 48 89 85 ? ? ? ? 44 8B 89").Get();
...
uint64_t FindKickPlayer()
{
    ...
    else if (VersionInfo.EngineVersion >= 5.4)
    {
        ...
        if (!pattern)
            pattern =
                Memcury::Scanner::FindPattern("48 89 5C 24 ? 55 56 57 41 54 41 55 41 56 41 57 48 8D AC 24 ? ? ? ? 48 81 EC ? ? ? ? 48 8B 05 ? ? ? ? 48 33 C4 48 89 85 ? ? ? ? 45 33 ED 48 89 55 ? 41 8B FD").Get();
...
uint64_t FindCallPreReplication()
{
    ...
    if (!bInitialized)
    {
        ...
        else if (VersionInfo.FortniteVersion <= 22.20)
        {
            ...
            if (!CallPreReplication)
                CallPreReplication = Memcury::Scanner::FindPattern("48 85 D2 0F 84 ? ? ? ? 48 89 5C 24 ? 48 89 74 24 ? 48 89 7C 24 ? 55 41 54 41 55 41 56 41 57 48 8B EC 48 83 EC ? F6 41").Get();
        }
