...
uint64_t FindFinishedTargetSpline()
{
    ...
    if (!bInitialized)
    {
        ...
        else if (VersionInfo.EngineVersion >= 5.3)
        {
            ...
            if (!FinishedTargetSpline)
                FinishedTargetSpline = Memcury::Scanner::FindPattern("48 8B C4 48 89 58 ? 48 89 70 ? 48 89 78 ? 55 41 54 41 55 41 56 41 57 48 8D A8 ? ? ? ? 48 81 EC ? ? ? ? 48 8B 05 ? ? ? ? 48 33 C4 48 89 85 ? ? ? ? 48 8B F9 48 89 4C 24 ? 48 81 C1").Get();
        }
    }
...
uint64 FindSetState() // yea yea ik its not very uni ploosh u can fix - andr1ww
{
    if (VersionInfo.FortniteVersion <= 9.10) 
        return Memcury::Scanner::FindPattern("4C 8B DC 55 53 56 57 41 56 49 8D 6B ? 48 81 EC ? ? ? ? 48 8B 05 ? ? ? ? 48 33 C4 48 89 45 ? 33 F6 0F B6 FA").Get();
